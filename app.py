    ...
    <body>
        ...
        <div class="footer-section">
            <div class="signature-block">
                ...
                <div>Civil / Structural Engineer</div>
            </div>
        </div>
    </body>
    </html>
...
with st.sidebar.form("inputs"):
    ...
    beam_id = st.text_input("Beam Number", value="B-01")  # Input ใหม่สำหรับ Beam Number
...
if run_btn:
    inputs = {
        'project': project_name, 'beam_id': beam_id,  # Added beam_id
